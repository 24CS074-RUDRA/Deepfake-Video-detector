...
from ai.utils.config import IMG_SIZE, PROCESSED_DATASET, MODEL_DIR, REPORT_DIR
...
def evaluate_model(limit=None):
    ...
    # 3. Load the held-out test split generated by preprocessing.
    ...
    val_dataset = dataset
    print(f"Loaded {len(val_dataset)} test videos.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit", type=int, default=None, help="Maximum test videos.")
    evaluate_model(limit=parser.parse_args().limit)
